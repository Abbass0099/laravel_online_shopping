...
@section('content')
    ...
    <div class="uk-child-width-1-1@s uk-light" uk-grid>
        <div class="image-cover-parent">
            <div class="uk-background-cover uk-height-large uk-panel uk-flex uk-flex-center uk-flex-middle" style="background-image: url({{asset('assets/images/home.png')}});">
            ...
            <div class="categories uk-container">
                <div class="uk-grid-small uk-child-width-expand@s uk-text-center" uk-grid>
                    <div><a href="#"><img src="{{asset('assets/icons/medication.svg')}}" alt="" />Pharmacy products</a></div>
                    <div><a href="#"><img src="{{asset('assets/icons/oil.svg')}}" alt="">Device products</a></div>
                    <div><a href="#"><img src="{{asset('assets/icons/pesticide.svg')}}" alt="">Food products</a></div>
                    <div><a href="#"><img src="{{asset('assets/icons/pesticide.svg')}}" alt="">Chemical products</a></div>
                    <div><a href="#"><img src="{{asset('assets/icons/agriculture.svg')}}" alt="">Agriculture products</a></div>
                    <div><a href="#"><img src="{{asset('assets/icons/pesticide.svg')}}" alt="">Cosmetics&Beauty</a></div>
                    <div><a href="#"><img src="{{asset('assets/icons/pesticide.svg')}}" alt="">Other products</a></div>
                </div>
            </div>
        </div>
    </div>
    <section class="deals">
        ...
        <div class="uk-container">
            ...
            <div class="uk-child-width-1-3@s uk-flex uk-flex-center uk-flex-middle uk-grid-small" uk-grid>
                <div>
                    <div class="uk-background-cover uk-height-medium uk-panel uk-flex uk-flex-center uk-flex-bottom" style="border-radius: 3px; background-image: url({{asset('assets/images/home.png')}});">
                    <h4>Today deals</h4>
                    </div>
                </div>
                <div>
                    <div class="uk-background-cover uk-height-medium uk-panel uk-flex uk-flex-center uk-flex-bottom" style="border-radius: 3px; background-image: url({{asset('assets/images/surface-laptop-2.jpg')}});">
                        <h4>Special deals</h4>
                    </div>
                </div>
                <div>
                    <div class="uk-background-cover uk-height-medium uk-panel uk-flex uk-flex-center uk-flex-bottom" style="border-radius: 3px; background-image: url({{asset('assets/images/apple-brand-device-1334598.jpg')}});">
                        <h4>Free deals</h4>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="uk-slider-items uk-child-width-1-4@s">
                            ...
                            <div>
                                <div class="uk-card uk-card-default uk-card-small">
                                    <div class="uk-card-media-top">
                                        <img src="{{asset('assets/images/apple-brand-device-1334598.jpg')}}" alt="">
                                    </div>
                        ...
                        <li>
                            <div>
                                <div class="uk-card uk-card-default uk-card-small">
                                    <div class="uk-card-media-top">
                                        <img src="{{asset('assets/images/Sofia-Body-Shampoo-shower-gel-shower-cream.jpg')}}" alt="">
                                    </div>
                                    <div class="uk-card-body">
                                        <div class="uk-card-badge uk-label">-10$</div>
                                        <div uk-grid>
                        ...
                        <li>
                            <div>
                                <div class="uk-card uk-card-default uk-card-small">
                                    <div class="uk-card-media-top">
                                        <img src="{{asset('assets/images/surface-laptop-2.jpg')}}" alt="">
                                    </div>
                                    <div class="uk-card-body">
                                        <div class="uk-card-badge uk-label">-10$</div>
                                        <div uk-grid>
                        ...
                        <li>
                            <div>
                                <div class="uk-card uk-card-default uk-card-small">
                                    <div class="uk-card-media-top ">
                                        <img src="{{asset('assets/images/764378_0.png')}}" alt="">
                                    </div>
                                    <div class="uk-card-body">
                                        <div uk-grid>
                                            <div class="uk-width-1-2@s cat">
...
<script>
    UIkit.notification("<div class='uk-alert-danger'>{{session('error')}}</div>")
</script>
@endif
@if(session()->has('error-login'))
<script>
    UIkit.notification("<div class='uk-alert-danger'>{{session('error-login')}}</div>")
