...
@section('content')
<div class="breadcrumb-div uk-background-cover uk-height-small uk-flex uk-flex-middle uk-light" data-src="{{asset('assets/images/home.png')}}" uk-img>
    <div>
        <h3>How it works</h3>
        ...
        <div class="uk-child-width-1-1@s how-it-items" uk-grid>
            <div>
                <div class="uk-child-width-1-2@s" uk-grid>
                    ...
                    <div class="uk-text-right">
                        <img data-src="{{asset('assets/icons/creat-content.svg')}}" uk-img alt="">
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="uk-child-width-1-2@s" uk-grid>
                    ...
                    <div class="uk-text-right">
                        <img data-src="{{asset('assets/icons/post-an-add.svg')}}" uk-img alt="">
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="uk-child-width-1-2@s" uk-grid>
                    <div class="uk-text-left">
                        <img data-src="{{asset('assets/icons/earning.svg')}}" uk-img alt="">
                    </div>
                    <div class="uk-text-center">
