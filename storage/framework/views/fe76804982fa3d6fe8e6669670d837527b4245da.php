<footer>
    <div class="links-footer">
        <div class="uk-child-width-1-5@s" uk-grid>
            <div class="shop-pic">
                <img src="<?php echo e(asset('assets/images/shopping.png')); ?>" alt="">
            </div>
            ...
            <div uk-grid>
                <table>
                    <tr>
                        <td>
                            <img src="<?php echo e(asset('assets/images/The-FACE-Baked-Blush-Nectar-768x768.jpg')); ?>" width="90" height="50" alt="">
                        </td>
                        <td>
                            <ul class="uk-list">
                                <li>Velvet Plush</li>
    ...
    <div class="copyrights">
        <div class="uk-child-expand-1-1@s uk-flex uk-flex-center" uk-grid>
            <div class="copyright-date">
                <hr />
                Copyright&copy <?php echo e(date('Y')); ?> ShoppingNow.com. All rights reserved.<br />
            </div>
        </div>
    </div>
</footer>
...
<div id="register-modal" uk-modal>
    <div class="uk-modal-dialog uk-modal-body">
        ...
        <div class="">
            ...
            <form class="uk-grid-small uk-form-stacked" action="<?php echo e(url('seller_register')); ?>" id="seller-signup" uk-grid enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="uk-inline uk-width-1-2@s">
                        ...
                        <select name="sector_id" id="" class="uk-select">
                            ...
                            <option value="<?php echo e($sector->id); ?>"><?php echo e(ucfirst($sector->sector_name)); ?></option>
...
<div id="seller-login-modal" uk-modal>
    <div class="uk-modal-dialog uk-modal-body">
        ...
        <div class="">
            <div class="uk-child-width-1-1@s uk-flex uk-flex-center uk-flex-middle">
            <form class="uk-grid-small uk-form-stacked" action="<?php echo e(url('seller_login')); ?>" id="seller-login-form" uk-grid>
                    <?php echo csrf_field(); ?>
                    <div class="uk-inline uk-width-1-2@s">
                        <label for="" class="uk-form-label">Email</label>
...
</html><?php /**PATH D:\{}{}{}{}{}{}{}{}{}\LESSONSS\Courses + Projects\Projects\Al masre project\online_shopping-master\resources\views/layouts/footer.blade.php ENDPATH**/ ?>